...
INSERT INTO "new_Booking" ("created_at", "duration", "id", "id_booking", "memberId", "name", "payment_method", "status", "tableId", "total_price", "updated_at") SELECT "created_at", "duration", "id", "id_booking", "memberId", "name", "payment_method", "status", "tableId", "total_price", "updated_at" FROM "Booking";
DROP TABLE "Booking";
