...
INSERT INTO "new_OrderCafe" ("bookingId", "cash", "change", "created_at", "id", "id_order_cafe", "menu_cafe", "qty", "status", "subtotal", "total", "updated_at", "userId") SELECT "bookingId", "cash", "change", "created_at", "id", "id_order_cafe", "menu_cafe", "qty", "status", "subtotal", "total", "updated_at", "userId" FROM "OrderCafe";
