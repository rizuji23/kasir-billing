...
CREATE TABLE "new_Booking" (
    ...
    "type_customer" TEXT NOT NULL DEFAULT 'BIASA',
...
INSERT INTO "new_Booking" ("created_at", "duration", "id", "idPaketPrice", "idPriceType", "id_booking", "memberId", "name", "payment_method", "shift", "status", "tableId", "total_price", "type_play", "updated_at") SELECT "created_at", "duration", "id", "idPaketPrice", "idPriceType", "id_booking", "memberId", "name", "payment_method", "shift", "status", "tableId", "total_price", "type_play", "updated_at" FROM "Booking";
DROP TABLE "Booking";
