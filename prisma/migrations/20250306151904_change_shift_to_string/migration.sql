...
INSERT INTO "new_OrderCafeItem" ("created_at", "id", "id_order_cafe_item", "menu_cafe", "orderId", "price", "shift", "updated_at") SELECT "created_at", "id", "id_order_cafe_item", "menu_cafe", "orderId", "price", "shift", "updated_at" FROM "OrderCafeItem";
...
INSERT INTO "new_Struk" ("cash", "change", "created_at", "id", "id_booking", "id_order_in", "id_struk", "is_split_bill", "name", "payment_method", "shift", "status", "total", "total_billing", "total_cafe", "type_struk", "updated_at") SELECT "cash", "change", "created_at", "id", "id_booking", "id_order_in", "id_struk", "is_split_bill", "name", "payment_method", "shift", "status", "total", "total_billing", "total_cafe", "type_struk", "updated_at" FROM "Struk";
DROP TABLE "Struk";
