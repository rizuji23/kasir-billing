...
INSERT INTO "new_TableBilliard" ("created_at", "duration", "id", "id_table", "name", "status", "timer", "type_play", "updated_at") SELECT "created_at", "duration", "id", "id_table", "name", "status", "timer", "type_play", "updated_at" FROM "TableBilliard";
