...
export default function ResetReport() {
    ...
    const getDataRincian = async ({ filter = "today", start_date = "", end_date = "" }: { filter?: string; start_date?: string; end_date?: string }) => {
        ...
        try {
            ...
            const res = await window.api.reset_report({ period: filter, start_date, end_date }, shift);
            setLoading(false);
    ...
    return (
        <>
            <div className="grid gap-3">
                <ReportTitle title={`Rincian Reset Billing`} desc={billing?.period} setSelected={setSelected} getDataRincian={getDataRincian} loading={loading} />
                            ...
                            <div className="flex justify-between">
                                <div className="flex flex-col gap-4">
                                    <div className="grid gap-2">
                                        <h3 className="text-xl font-bold">Total Reset Billiard</h3>
